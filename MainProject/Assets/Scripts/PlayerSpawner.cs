...
public class PlayerSpawner : MonoBehaviour
{
    ...
    void SpawnPlayers()
    {
        ...
        var topPlayer1 = Instantiate(playerPrefab[Random.Range(2, 2)], topSpawnPosition, Quaternion.Euler(0f,0f,180f));
        var bottomPlayer1 = Instantiate(playerPrefab[Random.Range(2, 2)], bottomSpawnPosition, Quaternion.identity);
